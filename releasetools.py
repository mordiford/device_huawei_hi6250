...
def FullOTA_InstallBegin(info):
  info.script.AppendExtra('ui_print("          Tested for your P8 Lite 2017 by          ");');
  info.script.AppendExtra('ui_print("                Haky86 aka La Volpe                ");');
  info.script.AppendExtra('ui_print("  Capra, capra, capra, svegliati. Vittorio Sgarbi  ");');
  info.script.AppendExtra('ui_print("    goat, goat, goat, Wake Up. Vittorio Sgarbi     ");');
